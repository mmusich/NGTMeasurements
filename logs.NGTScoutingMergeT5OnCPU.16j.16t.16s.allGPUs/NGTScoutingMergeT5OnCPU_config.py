...
# with command line options: Phase2 -s L1P2GT,HLT:NGTScouting --processName=HLTX --conditions auto:phase2_realistic_T33 --geometry ExtendedRun4D110 --era Phase2C17I13M9 --customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_1000 --eventcontent FEVTDEBUGHLT --filein=file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/00a72589-5bf0-4578-ae3c-620aed9b1312.root,file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/01689ce8-a6a3-4e3a-9a63-209e16af6f76.root,file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/02c1618c-aae5-4f0e-a8ad-a31c4d925296.root,file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/05a22619-9cb6-4d83-9bdf-9c59bc943124.root,file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/088d165d-ad75-48b5-8fb5-cacab239566f.root,file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/0c07f6a5-8e09-4efb-a025-074651357849.root,file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/0cc74783-4717-4ef7-8c0f-66ef100714fd.root,file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/0eaefa74-0a46-464f-a90a-bd5f02468cad.root,file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/0ee6887a-f1a4-4594-afc8-e9cc4dc1dcac.root,file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/11344b2a-f627-421a-ab00-eb73fc0cfccf.root --procModifiers ngtScouting,trackingLST --mc '--inputCommands=keep *, drop *_hlt*_*_HLT, drop triggerTriggerFilterObjectWithRefs_l1t*_*_HLT' -n -1 --no_exec '--output={}' --python_filename NGTScoutingMergeT5OnCPU_config.py
...
process = cms.Process('HLTX',Phase2C17I13M9,ngtScouting,trackingLST)
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        'file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/00a72589-5bf0-4578-ae3c-620aed9b1312.root',
        'file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/01689ce8-a6a3-4e3a-9a63-209e16af6f76.root',
        'file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/02c1618c-aae5-4f0e-a8ad-a31c4d925296.root',
        'file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/05a22619-9cb6-4d83-9bdf-9c59bc943124.root',
        'file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/088d165d-ad75-48b5-8fb5-cacab239566f.root',
        'file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/0c07f6a5-8e09-4efb-a025-074651357849.root',
        'file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/0cc74783-4717-4ef7-8c0f-66ef100714fd.root',
        'file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/0eaefa74-0a46-464f-a90a-bd5f02468cad.root',
        'file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/0ee6887a-f1a4-4594-afc8-e9cc4dc1dcac.root',
        'file:/cms-hlt-nfs/data/relValTTbar_200PU/CMSSW_16_0_0_pre1/11344b2a-f627-421a-ab00-eb73fc0cfccf.root'
    ),
